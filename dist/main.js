...
var widok = __webpack_require__(/*! ./widok */ "./src/js/widok.js");

var moreButton = $('#atrraction-more');
var verticalImageTextMore768 = $('.vertical-image-text.vertical-image-more-768');
var isMore = false;
var isMobile = true;
moreButton.on('click', function () {
  ...
  if (!isMore) {
    ...
    verticalImageTextMore768.each(function (index, element) {
      $(element).css({
...
var createScrollItem = __webpack_require__(/*! ./widok-scrollItem */ "./src/js/widok-scrollItem.js");

var widok = __webpack_require__(/*! ./widok */ "./src/js/widok.js");

$('.cake-frame').each(function (index, element) {// createScrollItem($(element).parent('.cake'), {
  //   isActive: false,
  //   onScroll: scrollItem => {
...
var createScrollItem = __webpack_require__(/*! ./widok-scrollItem.js */ "./src/js/widok-scrollItem.js");

var widok = __webpack_require__(/*! ./widok.js */ "./src/js/widok.js");

var fixedLink = $('.fixed-link');
var fixedLinkContainer = $('.fixed-link-container');

var fixedOrAbs = function fixedOrAbs(scrollItem) {
  var isLayoutChange = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var currentFixedLink = scrollItem.options.currentFixedLink;
  var currentFixedLinkH = scrollItem.options.currentFixedLinkH;
  var currentFixedLinkW = scrollItem.options.currentFixedLinkW;

  if (scrollItem.offset + currentFixedLinkH + widok.em * 2 > widok.s + widok.h || scrollItem.offset + scrollItem.height < widok.s + widok.h) {
    if (isLayoutChange || scrollItem.options.isFixed) {
      ...
      } else if (scrollItem.offset + currentFixedLinkH + widok.em * 2 > widok.s + widok.h) {
        currentFixedLink.css({
          bottom: 'auto',
...
$.each(fixedLinkContainer, function (index, e) {
  var currentFixedLink = $(fixedLink[index]);
  var item = createScrollItem(e, {
    onScroll: function onScroll(scrollItem) {
      return fixedOrAbs(scrollItem);
    },
    isFixed: false,
    currentFixedLink: currentFixedLink,
    currentFixedLinkH: currentFixedLink.height(),
    currentFixedLinkW: currentFixedLink.width()
  });

  item._onResize = function () {
...
var videoOverlay = $('#footer-video-overlay');
...
var createSlider = __webpack_require__(/*! ./widok-slider */ "./src/js/widok-slider.js");

var createLightbox = __webpack_require__(/*! ./widok-lightbox */ "./src/js/widok-lightbox.js");
...
function onImageChange() {
  ...
  var imageSrc = imageSrc === undefined ? this.$element.data('full-image') : imageSrc;
  ...
  setTimeout(function () {
    if (_this.parent.currentLb === _this.id) {
      _this.parent.$containerIn.find('.image-container').css({
        opacity: 1
      });
    }
  }, 300);
...
var singleLb = createLightbox((_createLightbox = {
  items: '.single-slide',
...
}, _defineProperty(_createLightbox, "onChange", onImageActivate), _defineProperty(_createLightbox, "hasArrows", true), _defineProperty(_createLightbox, "hasExit", true), _defineProperty(_createLightbox, "exitClass", '#lb-container-image .close-lb'), _defineProperty(_createLightbox, "loop", true), _createLightbox));
var masonryLb = createLightbox({
  items: '.masonry-icon',
...
$('.slider-with-bullets').each(function (index, element) {
  createSlider({
    wrap: "#slider-with-bullets-".concat(index, " .slider"),
    bulletContainer: "#slider-with-bullets-".concat(index, " .bullets-container"),
    bulletSelector: "#slider-with-bullets-".concat(index, " .bullet"),
    useKeys: true,
    touchDrag: true,
    arrowPrev: "#slider-with-bullets-".concat(index, " .arrow-left"),
    arrowNext: "#slider-with-bullets-".concat(index, " .arrow-right")
  });
});
createSlider({
...
var createHoverable = function () {
  var Hoverable = /*#__PURE__*/function () {
...
var createLightbox = function () {
  var SingleLightbox = /*#__PURE__*/function () {
    function SingleLightbox(i, e, parent) {
      var _this = this;
  ...
  var Lightbox = /*#__PURE__*/function () {
    function Lightbox(options) {
      ...
      this.$items.map(function (i, e) {
        var singleLb = new SingleLightbox(i, e, _this2);

        _this2.lightboxCollection.push(singleLb);
      });
      this.$container.on('click', function () {
        _this2.deactive();
      });
      this.$containerIn.on('click', function (e) {
        e.stopPropagation();
      });
      $(document).on('keyup', function (e) {
        if (e.keyCode === 27) _this2.deactive();
      });

      if (this.hasArrows) {
        $(document).on('keyup', function (e) {
          if (e.keyCode === 37) _this2.prevLb();else if (e.keyCode === 39) _this2.nextLb();
        });
    ...
    _createClass(Lightbox, [{
      ...
      value: function active(id) {
        ...
        if (!this.onScreen) {
          ...
          setTimeout(function () {
            _this3.$container.addClass('active');
          }, 0);
          this.currentLb = id;
          this.checkArrows();
      ...
      value: function deactive() {
        ...
        if (this.onScreen) {
          ...
          setTimeout(function () {
            _this4.$container.addClass('hidden');
          }, 300);
      ...
      key: "recreate",
      value: function recreate(items) {
        var _this5 = this;

        this.lightboxCollection.map(function (singleLightbox) {
          return singleLightbox.destroy();
        });
        this.lightboxCollection = [];
        ...
        this.$items.map(function (i, e) {
          var singleLb = new SingleLightbox(i, e, _this5);

          _this5.lightboxCollection.push(singleLb);
        });
      }
    }]);
...
if (true) module.exports = createLightbox;

/***/ }),

/***/ "./src/js/widok-scrollItem.js":
/*!************************************!*\
  !*** ./src/js/widok-scrollItem.js ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var createScrollItem = function () {
  var ScrollItem = /*#__PURE__*/function () {
    ...
    _createClass(ScrollItem, [{
      ...
      key: "checkScreenRelation",
      value: function checkScreenRelation() {
        ...
        this.setPropClass('CrossingScreenTop', this.offset < widok.s && this.offset + this.height > widok.s);
        this.setPropClass('CrossingScreenBottom', this.offset < widok.s + widok.h && this.offset + this.height > widok.s + widok.h);
      }
    }, {
      key: "setPropClass",
      value: function setPropClass(prop, value) {
        if (this['is' + prop] !== value) {
          this['is' + prop] = value;

          if (this.addClasses) {
            if (value) this.element.addClass(prop);else this.element.removeClass(prop);
          }
      ...
      key: "screenPos",
      value: function screenPos(heightOffset) {
  ...
  return function (element, options) {
    ...
    var scrollItem = new ScrollItem(element, options);
    scrollItemCollection.push(scrollItem);
    return scrollItem;
  };
}();

if (true) module.exports = createScrollItem;

/***/ }),

/***/ "./src/js/widok-slider.js":
/*!********************************!*\
  !*** ./src/js/widok-slider.js ***!
  \********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var createHoverable = __webpack_require__(/*! ./widok-hoverable */ "./src/js/widok-hoverable.js");
...
var throttle = __webpack_require__(/*! ./widok-throttle */ "./src/js/widok-throttle.js");
...
/***/ "./node_modules/widok-fade-queue/node_modules/widok-throttle/widok-throttle.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/widok-fade-queue/node_modules/widok-throttle/widok-throttle.js ***!
  \*************************************************************************************/
...
/***/ "./node_modules/widok-fade-queue/widok-fade-queue.js":
/*!***********************************************************!*\
  !*** ./node_modules/widok-fade-queue/widok-fade-queue.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var widok_throttle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! widok-throttle */ "./node_modules/widok-fade-queue/node_modules/widok-throttle/widok-throttle.js");
...
function fadeQueueStart(options = {}) {
  ...
  cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(opt.selector).each((index, element) => {
    fades.push(new Fade(element));
  });
  fades.sort((a, b) => a.order - b.order);

  window.addEventListener('load', fadeOnResize);
  window.addEventListener('resize', (0,widok_throttle__WEBPACK_IMPORTED_MODULE_1__.default)(100, fadeOnResize));
  window.addEventListener('scroll', (0,widok_throttle__WEBPACK_IMPORTED_MODULE_1__.default)(100, fadeOnScroll));
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fadeQueueStart);
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var widok_fade_queue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! widok-fade-queue */ "./node_modules/widok-fade-queue/widok-fade-queue.js");


var $ = __webpack_require__(/*! cash-dom */ "./node_modules/cash-dom/dist/cash.js");

__webpack_require__(/*! ./widok */ "./src/js/widok.js");
...
__webpack_require__(/*! ./cake-frame */ "./src/js/cake-frame.js");

var bodyElement = $('body');
if ($('.fixed-link').length > 0) __webpack_require__(/*! ./fixed-link */ "./src/js/fixed-link.js");
if ($('#top').length > 0) __webpack_require__(/*! ./top */ "./src/js/top.js");
if ($('.slider-gallery').length > 0) __webpack_require__(/*! ./slider-gallery */ "./src/js/slider-gallery.js");
if (bodyElement.hasClass('page-template-t-atrakcje')) __webpack_require__(/*! ./attractions */ "./src/js/attractions.js");

if ($('.fade').length > 0) {
  (0,widok_fade_queue__WEBPACK_IMPORTED_MODULE_0__.default)({
    delay: 400
  });
}
})();
