...
<?php if (true) {?>
  ...
  .chooserCalendarItemWrap
  {
   ...
   #mainSearchField .medium-6, #mainSearchField .small-6
   {
   	float:left;
   	width:50%;
   }
     ...
     #mainSearchField .medium-5
   {
    ...
    #mainSearchField .medium-4 ,  #mainSearchField .small-4
   {
   	float:left;
   	width:33%;
   }
  ...
  @media only screen and (max-width: 700px)
  {
  				 ...
  				 <div class="columns">
  					...
  					var setDates = false;
  						 ...
  						 <form id="mainSearchForm" action="/rezerwacja" method="get">
  									 ...
  									 <input type="hidden" name="departure" id="departure" value="2020-05-23" />
  									 ...
  									 <div class="small-5 columns">
  												 ...
  												 <div class="row  chooserCntWrap">
  													 <div class="small-4 columns">
  														 <a class="chooserMinus"><i class="fas fa-minus"></i></a>
  													 </div>
  													 <div class="small-4 columns">
  														 <input type="text" readonly="readonly" value="2" id="adults" name="adults" class="chooserCnt">
  													 </div>
  													 <div class="small-4 columns">
  										 ...
  										 <div class="chooserPersonLabel">
  											 ...
  											 <div class="small-5 columns">
  												 <div class="row  chooserCntWrap">
  															 ...
  															 <div class="small-4 columns">
  																 <input type="text" readonly="readonly" value="0" id="child1" name="child1" class="chooserCnt">
  															 </div>
  															 <div class="small-4 columns">
  																	 <a class="chooserPlus"><i class="fas fa-plus"></i></a>
  															 </div>
  										 ...
  										 <div class="chooserPersonLabel">
  											 ...
  											 <div class="small-5 columns">
  												 <div class="row  chooserCntWrap">
  															 ...
  															 <div class="small-4 columns">
  																 <input type="text" readonly="readonly" value="0" id="child2" name="child2" class="chooserCnt">
  															 </div>
  															 <div class="small-4 columns">
  																	 <a class="chooserPlus"><i class="fas fa-plus"></i></a>
  															 </div>
                      ...
                      <div class="chooserPersonLabel">
                        ...
                        <div class="small-5 columns">
                          <div class="row  chooserCntWrap">
                                ...
                                <div class="small-4 columns">
                                  <input type="text" readonly="readonly" value="0" id="child3" name="child3" class="chooserCnt">
                                </div>
                                <div class="small-4 columns">
                                    <a class="chooserPlus"><i class="fas fa-plus"></i></a>
                                </div>
  						 ...
  						 <div class="chooserCalendarContent">
  							 ...
  							 <div class="chooserCalendarNav">
  									 <div class="row">
  											 <div class="columns">
  												 <div style="position:relative">
  													 <a class="chooserCalendarPrev">&nbsp;<i class="fas fa-chevron-left"></i>&nbsp;</a>
  											 <a class="chooserCalendarNext">&nbsp;<i class="fas fa-chevron-right"></i>&nbsp;</a>
  											 </div>
  									 </div>
  									 </div>
  							 </div>
  							 ...
  							 <div class="chooserCalendarWrap">
  								...
  								<div class="row">
  										<div class="columns small-4">
  										 <div class="chooserClear"><i class="fas fa-times"></i> Wyczyść</div>
  										</div>
    ...
    function dateToStr(divId, date, lang)
       {
         ...
         $(divId).html(' <big>'+f.getDate()+' </big><p><i class="show-for-large">'+monthNameLong+'</i></p><span>'+f.getFullYear()+'</span>');
   ...
   function calendar(year, month) {
   	...
   	final_html +=
   		'<div class="chooserCalendarItemWrap"><div class="chooserCalendarMonth">' + langArr["pl"]["monthNames"][month] + " " + year + "</div>";
   ...
   $(".chooserSlickCalendar").on("click", ".chCalAvb", function(e)
          {
            ...
            else
            {
                  ...
                  $('.chooserInfo').html('');
                  $('.chooserInfo').html('<div class="button" onclick="$(\'.chooserBox\').removeClass(\'disabled\');$(\'.chooserCalendarBox\').removeClass(\'chooserCalendarBoxShow\');$(\'#mainSearchForm\'); $(\'.bg_wrap\').css(\'opacity\',\'1\');">Wybierz</div>');
...
<style>
#hotresChooser .hotresAdultsChooser #hotresAdultsSelect ,#hotresChooser .hotresAdultsChooser #hotresChild1 ,#hotresChooser .hotresAdultsChooser #hotresChild2,#hotresChooser .hotresAdultsChooser #hotresChild3  {
    border-right: none;
    background: none;
    height: 100%;
    border: none;
...
#hotresChooser .hotresAdultsChooser #hotresChild1 option,#hotresChooser .hotresAdultsChooser #hotresChild2 option,#hotresChooser .hotresAdultsChooser #hotresChild3 option {
color:#000;
}
